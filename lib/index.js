...
function renderLinkOpen({
  ...
  return function (tokens, index, options, env, self) {
    ...
    return spaLink.mutatesRenderedOpen ? spaLink.mutateRenderedOpen(defaultRender(tokens, index, options, env, self)) : defaultRender(tokens, index, options, env, self);
  };
}
...
function renderLinkClose({
  ...
  return function (tokens, index, options, env, self) {
    ...
    return spaLink.mutatesRenderedClose ? spaLink.mutateRenderedClose(defaultRender(tokens, index, options, env, self)) : defaultRender(tokens, index, options, env, self);
  };
}
